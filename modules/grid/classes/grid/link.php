...
class Grid_Link {
	...
	public function render() {
		...
		{
			case 'submit':
				$link = form::submit('submit', $this->text, $this->property);
			break;
			case 'button':
				$link = html::anchor($this->action, '<button type="button">' . $this->text . '</button>', $this->property);
			break;
			case 'link':
			default:
				$link = html::anchor($this->action, $this->text, $this->property);
		}
		return $link;
	}
